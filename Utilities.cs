...
public class Casilla
{
  ...
  public static Dictionary<string, (Casilla, string)> npc = new Dictionary<string, (Casilla, string)>
    {
      {"🧙", (new Casilla("Rollo",0,0,2,"Rollo se manda la tertulia numero 5,pierdes un turno y te envia a tu posicion inicial",0), "🧙:Consorte atiendeme bien,es momento de enumerarte los logros de nuestra Revolucion")},
      {"👩", (new Casilla("Tu Mama",3,0,0,"Modifica tu habilidad para ser usada en todo momento y triplica tu movimiento",0), "👩:Tienes catarro por andar descalzo,dejame que te haga un cocimiento de quaisimi y estas en talla mi amor")},
      ...
      {"💡", (new Casilla("una Idea Brillante",2,0,2,"Gritas muy alto ciertas obscenidades duplicando tu velocidad de movimiento y aturdiendo al adversario",0), "")}
